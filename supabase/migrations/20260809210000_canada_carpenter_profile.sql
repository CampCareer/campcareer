-- Canada Carpenter occupation profile.
-- Exact NOC 2021 72310 Carpenters.
...
values (
  'CA:carpenter','CA','carpenter','Carpenters','NOC','2021 Version 1.0','72310','CAD',true,
  'Provincial and territorial apprenticeship and trade certification authorities; requirements vary by jurisdiction',
  'https://red-seal.ca/eng/trades/carpenter.shtml','profile_ready','2026-08-09',now()
)
...
values (
  'CA:carpenter','2025-11-19',132000,null,32.12,null,null,null,null,null,null,
  null,null,null,null,null,
  20,0,0,0,15,6,0,10,3,54,'career-opportunity-ca-v1','provisional',
  jsonb_build_object(
    'classification_scope','Exact NOC 2021 Version 1.0 unit group 72310 Carpenters.',
    'labour_scope','COPS reports 132,000 workers in 2023. Job Bank national median wage is CAD 32.12/hour, updated 2025-11-19.',
    'shortage_note','COPS classifies Carpenters as STRONG RISK OF SHORTAGE nationally for 2024-2033.',
    'visa_basis','NOC 72310 Carpenters is listed in the current Express Entry trade occupations category.',
    'entry_level_basis','NOC and Red Seal evidence support a structured apprenticeship-to-certification route; apprentices are included in NOC 72310.',
    'entry_burden_basis','Certification is provincial/territorial. It is compulsory in Quebec and voluntary elsewhere; Red Seal is available to qualified carpenters.',
    'salary_method','Canada v1 salary component uses exact Job Bank national median hourly wage bands; CAD 32.12/hour earns 6/10.',
    'vacancy_scope','Current Job Bank advertised-job counts are point-in-time and are not treated as a three-month vacancy series; intensity and trend score zero.',
    'program_gap','The current courses_ca catalogue has no verified carpenter programme record, so no programme link is fabricated.'
  ),'2026-08-09'
)
...
values (
  'CA:carpenter','72310','Carpenters',null,null,null,null,true,true,1,
  'https://noc.esdc.gc.ca/Structure/NOCProfile?GocTemplateCulture=en-CA&code=72310&version=2021.0','2026-08-09'
)
...
insert into public.country_occupation_links (
  ...
  ('CA:carpenter','job_search','Job Bank — Carpenter in Canada','https://www.jobbank.gc.ca/marketreport/summary-occupation/6388/ca','official_job_board',null,1,'2026-08-09'),
  ('CA:carpenter','source','NOC 2021 — Carpenters 72310','https://noc.esdc.gc.ca/Structure/NOCProfile?GocTemplateCulture=en-CA&code=72310&version=2021.0','official_classification',null,1,'2026-08-09'),
  ('CA:carpenter','source','Red Seal — Carpenter','https://red-seal.ca/eng/trades/carpenter.shtml','official_trade_standard',null,2,'2026-08-09'),
  ('CA:carpenter','source','IRCC — Express Entry category-based selection','https://www.canada.ca/en/immigration-refugees-citizenship/services/immigrate-canada/express-entry/rounds-invitations/category-based-selection.html','official_immigration',null,3,'2026-08-09')
on conflict (profile_key,link_type,url) do update set
  label=excluded.label,provider_type=excluded.provider_type,sort_order=excluded.sort_order,source_checked_at=excluded.source_checked_at;

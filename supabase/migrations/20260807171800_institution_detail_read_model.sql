-- Institution detail read model for the AU/CA Institutions MVP.
--
-- Keep the canonical catalog as the source of truth. This view shapes a
-- bounded server-side detail payload with source-backed campus locations,
-- study-area/programme-type summaries, and the official Australian CRICOS
-- provider code when available. Browser roles do not receive direct access.
...
comment on view public.institution_detail_v1 is
  'Service-role institution detail read model backed by canonical institution, campus, geography, programme and official identifier data.';

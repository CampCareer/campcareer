...
Adelaide can have lower rent than Melbourne or Sydney, but state nomination settings and course costs must be checked for the year and occupation. University group membership does not set a 485 duration: the current standard stay period depends on qualification level. Treat any city-level “best PR outcome” claim as a planning prompt rather than a guarantee.
...
The 485 stay period is not tied to Group of Eight status. Under the current standard setting, a bachelor’s or coursework/extended master’s degree receives two years, while a research master’s or doctoral degree receives three years. Eligible regional graduates may be able to apply for a separate second stream of one or two years; check the exact regional conditions with Home Affairs.

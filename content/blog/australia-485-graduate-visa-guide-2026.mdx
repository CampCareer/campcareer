...
description: "The complete 2026 guide to Australia's Temporary Graduate visa (subclass 485) — the streams explained, the age 35 cap, English requirement, qualification-based stay periods and how the 485 fits into a PR plan."
date: "2026-03-04"
readTime: "14 min"
tag: "Australia"
...
authorRole: "Reviewed July 2026 · Sources: Department of Home Affairs and Study Australia"
authorInitials: "CC"
reviewedBy: "CampCareer Editorial Team"
lastReviewed: "2026-07-19"
heroImage: "https://images.unsplash.com/photo-1529070538774-1843cb3265df?w=1200&q=80"
heroImageAlt: "A traveller preparing documents at an airport, representing the post-study visa process"
---
...
It is also a visa that changed substantially from July 2024. The age cap for most applicants dropped from 50 to 35, the English requirement increased, and the old Replacement stream ceased. Many guides still describe pre-2024 settings. This guide reflects the framework published by the Department of Home Affairs in July 2026; use its Visa Pricing Estimator for the charge that applies on the day you lodge.

<DataGrid>
  <DataCard num="35" label="Maximum age at application for most applicants (reduced from 50 in July 2024)" />
  <DataCard num="2–3 yrs" label="Standard stay period in the Post-Higher Education Work stream, depending on qualification" />
  <DataCard num="IELTS 6.5" label="Minimum English score required since 23 March 2024, with no band below 5.5" />
  <DataCard num="Check live" label="Visa charge — use Home Affairs' Visa Pricing Estimator before lodging" />
</DataGrid>
...
|---|---|---|
| **Post-Higher Education Work** | Bachelor's, Master's (coursework or research), or PhD graduates from a CRICOS-registered course | Usually 2–3 years, depending on qualification |
...
- **Indian nationals (under the Australia–India ECTA agreement)**: set agreement-based periods of 3 years for eligible Master's degrees and 4 years for doctoral degrees; a Bachelor with first-class STEM honours can be 3 years
...
## Visa application charge: check it immediately before lodging

The application charge is indexed and can change. Home Affairs does not present a single fixed amount on every stream page; it directs applicants to its **Visa Pricing Estimator**, which also accounts for the stream and additional applicants. Treat any fee quoted in an older guide, agent post or university article as a historical example—not as a lodgement amount.
...
Processing times vary considerably. Check the Department's official processing-time guide when you are ready to apply; published times are indicators based on recently decided cases, not a guarantee for an individual application.
...
The UK's Graduate Route and its current conditions should be checked directly with GOV.UK. Australia's standard Post-Higher Education Work period varies by qualification: 2 years for bachelor and coursework/extended master's degrees, and 3 years for research master's and doctoral degrees. Australia also has a stricter age cap for most applicants and a visa-stage English requirement. Our <a href="/blog/uk-vs-australia-international-students-2026">UK vs Australia comparison</a> covers the decision factors in more detail.
...
<CTA
  ...
  secondaryHref="/compare?countries=AU,UK,CA"
  secondaryLabel="Compare post-study pathways"
/>

---

*This guide reflects Subclass 485 settings published by the Department of Home Affairs in July 2026. Standard stay periods are 2 years for bachelor and coursework/extended master's degrees, and 3 years for research master's and doctoral degrees. Visa charges, eligibility criteria and processing times can change—verify them on the [official Post-Higher Education Work page](https://immi.homeaffairs.gov.au/visas/getting-a-visa/visa-listing/temporary-graduate-485/post-higher-education-work) and through the [Visa Pricing Estimator](https://immi.homeaffairs.gov.au/visas/visa-pricing-estimator?visa=485-19) before applying.*

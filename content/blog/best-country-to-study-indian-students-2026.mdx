...
**India-specific rules matter more than Go8 membership.** The Australia–India ECTA has separate 485 periods for eligible Indian nationals: eligible master’s degrees can receive three years and doctoral degrees four years, while a bachelor with first-class STEM honours can receive three years. Those periods are not a Go8 benefit, and current eligibility must be confirmed with Home Affairs before enrolling.

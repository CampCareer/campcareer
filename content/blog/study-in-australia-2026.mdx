...
<DataGrid>
  ...
  <DataCard num="2–3 years" label="Standard 485 stay period after an eligible higher-education qualification" />
...
**Post-study work rights can provide useful career runway, but they are not determined by university prestige.** Under the current Post-Higher Education Work stream, the standard stay depends on the completed qualification: two years for a bachelor’s degree or coursework master’s, and three years for a research master’s or doctoral degree. Separate arrangements apply to some Indian nationals, Hong Kong and British National Overseas passport holders, and eligible regional graduates. Check the [Department of Home Affairs 485 guidance](https://immi.homeaffairs.gov.au/Visa-subsite/Pages/work/485-post-study-work.aspx) for the rule that applies to you.
...
The Group of Eight is Australia's coalition of leading research universities. Its members can be useful to compare for a particular course, city, research strength and cost. **Go8 membership does not change the standard duration of the subclass 485 visa.**
...
<Callout type="info" title="Choose the course and location before the university label">
For the standard Post-Higher Education Work stream, a bachelor’s degree and coursework master’s generally receive two years, while a research master’s and doctoral degree generally receive three. A second regional graduate visa may be available for eligible graduates who meet the regional study and residence requirements. Compare the exact course, occupation and location rather than assuming a Go8 university produces a longer visa.
</Callout>
...
The standard Post-Higher Education Work stream duration depends on degree level. Location can matter for a separate second regional visa, but university group membership does not set the standard duration:

| Degree Level | Standard stay |
|---|---|
...
Some applicants have different periods under the Australia–India ECTA or because they hold a Hong Kong or British National Overseas passport. Eligible regional graduates may be able to apply for a second Post-Higher Education Work stream visa. These are separate rules, so verify them before selecting a city or provider.
...
**Adelaide** deserves specific attention for students with PR in mind because regional study and residence can be relevant to a possible second Post-Higher Education Work stream visa. That possibility is separate from university group membership and must be checked against the current Home Affairs regional criteria.
...
| Post-study work visa | Standard 485: 2–3 years by qualification | Up to 3 years, subject to current rules | Check current Graduate Route | Check current Irish rules |

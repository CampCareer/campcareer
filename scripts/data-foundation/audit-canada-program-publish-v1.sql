...
with joined as (
  ...
  select *,
    case
      ...
      when lower(coalesce(international_program_admission_status,'')) ~ '(not_yet_verified|not verified|should_be_checked|check_current_intake_availability|availability_separate|dli_and_study_permit_eligibility_not_verified)'

      ...
      <div className="space-y-8 text-sm leading-relaxed text-slate-600">
        <section>
          ...
          <p>
            ...
            you agree to these terms. If you do not agree, please do not use the Service. A digital
            purchase is also subject to the version of these terms linked at checkout for that purchase.
          </p>
        </section>
        ...
        <section>
          ...
          <p className="mt-3">
            This does not remove rights that cannot lawfully be excluded. If digital content is not supplied,
            is materially faulty, does not conform to the purchase description, or another statutory remedy
            applies, you may be entitled to re-supply, repair, a price reduction, refund, cancellation, or
            another remedy under applicable consumer law. CampCareer does not use these terms to impose a
            blanket &quot;no refunds&quot; rule. We may verify the relevant order and payment before providing a
            remedy. Where a refund is due, it will be processed through the original payment channel unless
            applicable law or an agreement with you requires another method.
          </p>
        </section>
        ...
        <section>
          <h2 className="font-display text-lg font-semibold text-slate-800 mb-2">12. Contact and purchase support</h2>
          <p>
            Questions about these terms, a guide delivery problem, or a purchase remedy can be sent to{" "}
...
function KoreanTermsPage() {
  return (
    <div className="mx-auto max-w-3xl px-6 py-12">
      ...
      <div className="space-y-8 text-sm leading-relaxed text-slate-600">
        <section><h2 className="font-display mb-2 text-lg font-semibold text-slate-800">1. 약관 동의</h2><p>Yaehun Lee가 운영하는 campcareer.com과 CampCareer 서비스를 이용하면 본 약관에 동의하게 됩니다. 동의하지 않으면 서비스를 이용하지 마세요. 디지털 상품 구매에는 해당 구매 시 Checkout에서 연결된 약관 버전이 함께 적용됩니다.</p></section>
        ...
        <section>
          ...
          <p className="mt-3">이는 법적으로 배제할 수 없는 권리를 없애지 않습니다. 디지털 콘텐츠가 제공되지 않거나 중대한 하자가 있거나 구매 설명과 일치하지 않거나 기타 법정 구제 사유가 있는 경우 재제공, 수정, 가격 인하, 환불, 계약 종료 또는 적용 법률상 다른 구제를 받을 권리가 있을 수 있습니다. CampCareer는 본 약관으로 일률적인 “환불 불가” 규칙을 적용하지 않습니다. 구제 전 관련 주문과 결제를 확인할 수 있으며, 환불이 필요한 경우 적용 법률이나 별도 합의가 요구하지 않는 한 원래 결제 경로를 통해 처리합니다.</p>
        </section>
        ...
        <section><h2 className="font-display mb-2 text-lg font-semibold text-slate-800">12. 문의와 구매 지원</h2><p>약관, 가이드 전달 문제 또는 구매 관련 구제 문의는 <a href="mailto:leeyaehun@gmail.com" className="text-blue-600 hover:underline">leeyaehun@gmail.com</a>으로 보내주세요.</p></section>
      </div>

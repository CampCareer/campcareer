  ...
  return (
    <div className="max-w-3xl mx-auto px-6 py-12">
      ...
      <div className="space-y-8 text-sm leading-relaxed text-slate-600">
        ...
        <section>
          <h2 className="font-display text-lg font-semibold text-slate-800 mb-2">4. Acceptable use</h2>
          <p>
        ...
        <section>
          <h2 className="font-display text-lg font-semibold text-slate-800 mb-2">5. Availability and changes</h2>
          <p>
        ...
        <section>
          <h2 className="font-display text-lg font-semibold text-slate-800 mb-2">6. Limitation of liability</h2>
          <p>
        ...
        <section>
          <h2 className="font-display text-lg font-semibold text-slate-800 mb-2">7. Contact</h2>
          <p>

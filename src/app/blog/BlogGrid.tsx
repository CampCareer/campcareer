    ...
    <>
      ...
      {grid.length > 0 ? (
          ...
          {grid.map(post => (
            ...
            >
              ...
              <div className="flex items-center justify-between pt-4 border-t border-slate-100 mt-auto">
                ...
                <span className="inline-flex items-center gap-1 text-xs font-semibold text-indigo-500 group-hover:gap-2 transition-all whitespace-nowrap">
        ...
        <div className="text-center py-24">
          ...
          <button onClick={() => setActive("all")} className="mt-5 text-sm font-medium text-indigo-600 hover:underline">
            ← View all articles
          </button>
        </div>
      )}

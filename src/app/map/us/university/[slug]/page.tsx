...
export async function generateMetadata({ params }: { params: { slug: string } }) {
  ...
  const description = college.median_earnings != null
    ? `${college.college_name} in ${college.city_name}, ${college.college_state}. QS #${college.qsRank} · Median earnings $${college.median_earnings.toLocaleString()} · Graduation rate ${Math.round(college.graduation_rate! * 100)}% · ROI score ${college.roi_score}`
    : `${college.college_name} in ${college.city_name}, ${college.college_state}. QS #${college.qsRank}. Learn about tuition, earnings, and ROI.`

...
type OnboardingPageProps = {
  searchParams: Promise<{ country?: string | string[]; occupation?: string | string[]; returnTo?: string | string[] }>
}
...
function safeReturnPath(value: string | undefined) {
  ...
  return value.startsWith("/career?") || value.startsWith("/ko/career?") ? value : null
}
...
export default async function OnboardingPage({ searchParams }: OnboardingPageProps) {
  ...
  const explicitReturnTo = safeReturnPath(firstValue(params.returnTo))

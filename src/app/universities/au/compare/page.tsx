  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="mx-auto max-w-6xl px-5 py-8 sm:px-6">
        <form action="/universities/au/compare" className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">

...
export function CareerResultPage() {
  ...
  return <main className="min-h-[calc(100vh-3.5rem)] bg-white px-5 pb-16 pt-7 sm:px-8 sm:pt-10">
    <div className="mx-auto max-w-5xl">
      <Link href={localizePath("/", locale)} className="inline-flex items-center gap-1.5 text-sm font-medium text-slate-500 transition hover:text-slate-950"><ArrowLeft className="size-4" /> {locale === "ko" ? "다시 검색하기" : "Search again"}</Link>

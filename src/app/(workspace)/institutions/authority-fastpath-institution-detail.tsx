...
import type { AuthorityFastpathInstitutionDetailResult } from "@/lib/institutions/authority-fastpath-institution-detail.server"

const COUNTRY_CONFIG = {
  FI: { name: "Finland", profile: "Finland Tier A university", authority: "Finnish National Agency for Education / Study in Finland" },
...
export function AuthorityFastpathInstitutionDetailView({ result }: { result: AuthorityFastpathInstitutionDetailResult }) {

...
export const metadata = {
  ...
  description: "Japan salary ranges, student living costs, tuition, study calendar, strong fields, institutions and cities with official sources.",
  alternates: { canonical: "/countries/jp" },
  robots: { index: true, follow: true } as const,
}

export default async function JapanPage() {
  const metrics = await getBatch2CountryMetrics("JP")
  return <CountryDashboardShell countryCode="JP"><Batch2CountryDashboard metrics={metrics} profile={BATCH_2_COUNTRY_CONTENT.JP} /></CountryDashboardShell>
}

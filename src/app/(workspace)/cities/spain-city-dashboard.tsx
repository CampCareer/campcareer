...
export function SpainCityDashboard({ profile }: { profile: EsCityProfile }) {
  ...
  return <div>
    <section className="bg-gradient-to-br from-[#7a1f2b] via-[#b43f38] to-[#f2cf72] text-white">
      <div className="mx-auto w-full max-w-6xl px-4 pb-20 pt-14 sm:px-8 sm:pt-20 lg:px-10">
        <nav className="flex flex-wrap items-center gap-2 text-[11px] font-medium text-white/75" aria-label="Breadcrumb">
          ...
          <span>/</span>
          <Link href="/countries/es" className="hover:text-white">Spain</Link>
          <span>/</span>
        ...
        <p className="mt-2 text-[14px] font-medium text-white/90">
          {profile.regionName} · {profile.scopeLabel} · INE {profile.municipalityCode}
        </p>
      </div>
    </section>
    ...
    <main className="mx-auto w-full max-w-6xl px-4 pb-12 sm:px-8 lg:px-10">
      <section className="-mt-8 rounded-2xl border border-[#e7e6e3] bg-white p-5 shadow-xl shadow-black/10 sm:p-6">
        <p className="text-[12px] font-semibold text-[#9a302f]">Student decision snapshot</p>
        ...
        <p className="mt-1.5 max-w-3xl text-[12px] leading-5 text-[#77746e]">
          Population and route identity use the exact INE municipality boundary. Nearby teaching localities remain separate unless programme-level evidence proves delivery inside this municipality.
        </p>
      ...
      <div className="mt-5 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <article className="rounded-xl border border-[#e7e6e3] bg-white p-4">
          <div className="flex items-center gap-2 text-[#77746e]"><Users className="size-4 text-[#9a302f]" /><p className="text-[11px] font-semibold uppercase tracking-[0.08em]">Population</p></div>
          ...
          <p className="mt-1.5 text-[11.5px] leading-5 text-[#77746e]">{profile.population ? `${profile.population.geography} · ${profile.population.dataAsOf}` : "Verified population unavailable"}</p>
        </article>

        <article className="rounded-xl border border-[#e7e6e3] bg-white p-4">
          <div className="flex items-center gap-2 text-[#77746e]"><Wallet className="size-4 text-[#a56b00]" /><p className="text-[11px] font-semibold uppercase tracking-[0.08em]">Living-cost reference</p></div>
          ...
          <p className="mt-1.5 text-[11.5px] leading-5 text-[#77746e]">
            {profile.livingCost?.fullBudget ? "Full-budget source reference" : "Partial/component source reference"} · not a cheapest-city ranking
          </p>
        </article>
        ...
        <article className="rounded-xl border border-[#e7e6e3] bg-white p-4">
          ...
          <p className="mt-1.5 text-[11.5px] leading-5 text-[#77746e]">Source-native operator product period and eligibility</p>
        </article>
        ...
        <article className="rounded-xl border border-[#e7e6e3] bg-white p-4">
          ...
          <p className="mt-1.5 text-[11.5px] leading-5 text-[#77746e]">National residence-authorisation context · not a city differentiator</p>
        </article>
      </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-[11.5px] leading-5 text-[#7a5a31]">
              Current provider coverage is a selected public-university core with targeted Valencia and Granada expansion. Institution identity uses verified official names while stable RUCT code reconciliation remains pending.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className="mt-5 grid gap-5 lg:grid-cols-[minmax(0,1.4fr)_minmax(300px,0.8fr)]">
        <div className="space-y-5">
          <section className="rounded-xl border border-[#e7e6e3] bg-white p-5 sm:p-6">
            <div className="flex flex-wrap items-center gap-2 text-[#9a302f]">
            ...
            <p className="mt-2 text-[11.5px] leading-5 text-[#77746e]">Each entry has an official teaching-location source. It is not a complete campus inventory.</p>
            <div className="mt-4 grid gap-2.5 sm:grid-cols-2">
              {profile.institutions.map((institution) => <article key={institution.id} className="rounded-lg border border-[#eeece8] bg-[#fafaf8] p-3.5">
                <div className="flex gap-3">
                  <Building2 className="mt-1 size-4 shrink-0 text-[#9a302f]" />
                  <div className="min-w-0">
                    ...
                    {institution.websiteUrl ? <a href={institution.websiteUrl} target="_blank" rel="noreferrer" className="mt-2 inline-block text-[10.5px] font-semibold text-[#9a302f] hover:underline">Official site <ExternalLink className="inline size-3" /></a> : null}
                  </div>
                </div>
              </article>)}
            </div>
          ...
          <section className="rounded-xl border border-[#e7e6e3] bg-white p-5 sm:p-6">
            ...
            {profile.programmeSample.length ? <>
              <p className="mt-2 text-[11.5px] leading-5 text-[#77746e]">Up to 8 examples from {profile.linkedProgramCount} strict source-city matched programmes. The count remains verified-partial.</p>
        ...
        <div className="space-y-5">
          <section className="rounded-xl border border-[#e7e6e3] bg-white p-5">
            ...
            <p className="mt-2 text-[11.5px] leading-5 text-[#77746e]">{profile.employmentSectorBasis}. Official/local context only, not a shortage ranking or job guarantee.</p>

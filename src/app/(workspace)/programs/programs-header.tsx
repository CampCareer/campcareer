...
const PUBLISHED_PROGRAM_COUNTRIES = new Set(["AU", "UK"])
          ...
          <form onSubmit={submitSearch} className="mt-6 max-w-3xl">
            <label className="relative block">
              ...
              <input
                ...
                placeholder={locale === "ko" ? "과정명 또는 학교명으로 검색하세요" : filters.country === "UK" ? "Search UK programmes or institutions…" : "Search programs, e.g. Nursing or Data Science…"}

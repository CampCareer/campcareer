    ...
    <div className="bg-slate-900 rounded-2xl p-6 sm:p-8">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3">
        <input
          ...
          className="flex-1 rounded-lg border border-slate-700 bg-slate-800 px-4 py-2.5 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
        />
        <button
          type="submit"
          disabled={status === "submitting"}
          className="inline-flex items-center justify-center gap-2 rounded-lg bg-indigo-600 hover:bg-indigo-500 disabled:opacity-60 px-5 py-2.5 text-sm font-semibold text-white transition-colors"
        >
      ...
      <label className="mt-4 flex items-start gap-2.5 text-xs text-slate-400 cursor-pointer">
        <input
          ...
          className="mt-0.5 h-3.5 w-3.5 rounded border-slate-600 bg-slate-800 accent-indigo-500"
        />
        <span>

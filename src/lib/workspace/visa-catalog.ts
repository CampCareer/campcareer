...
export const VISA_CATALOG: readonly VisaEntry[] = [
  ...
  { country: "United Kingdom", countryCode: "GB", name: "Student visa", kind: "Study", note: "Study at an accredited UK education provider.", authority: "Home Office", url: "https://www.gov.uk/student-visa" },
  { country: "United Kingdom", countryCode: "GB", name: "Skilled Worker", kind: "Work", note: "Work for an approved UK sponsor in an eligible occupation.", authority: "Home Office", url: "https://www.gov.uk/skilled-worker-visa" },
  { country: "United Kingdom", countryCode: "GB", name: "Graduate visa", kind: "Work", note: "Stay in the UK to work after completing a degree.", authority: "Home Office", url: "https://www.gov.uk/graduate-visa" },
  { country: "United Kingdom", countryCode: "GB", name: "Health and Care Worker", kind: "Work", note: "Faster visa route for health and adult social care roles.", authority: "Home Office", url: "https://www.gov.uk/health-care-worker-visa" },
  { country: "United Kingdom", countryCode: "GB", name: "Youth Mobility Scheme", kind: "Working holiday", note: "Two-year working holiday for young people from partner countries.", authority: "Home Office", url: "https://www.gov.uk/youth-mobility" },

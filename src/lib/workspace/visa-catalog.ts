...
export const VISA_CATALOG: readonly VisaEntry[] = [
  ...
  { country: "Spain", countryCode: "ES", name: "Student visa", kind: "Study", note: "Long-term study authorization for eligible higher education or post-compulsory secondary study.", authority: "Ministry of Inclusion, Social Security and Migration", url: "https://www.inclusion.gob.es/en/web/migraciones/w/estancia-por-estudios" },
  { country: "Spain", countryCode: "ES", name: "Graduate job-search residence", kind: "Temporary", note: "Non-renewable 24-month residence after eligible Spanish higher education to seek degree-related work or prepare a business project; it does not itself authorise work.", authority: "Ministry of Inclusion, Social Security and Migration", url: "https://www.inclusion.gob.es/web/migraciones/w/20.-autorizacion-de-residencia-para-busqueda-de-empleo-o-inicio-de-proyecto-empresarial" },
  { country: "Spain", countryCode: "ES", name: "Internship residence", kind: "Work", note: "Residence for a qualifying internship agreement or internship employment contract linked to higher education.", authority: "Ministry of Inclusion, Social Security and Migration", url: "https://www.inclusion.gob.es/en/web/migraciones/w/21.-autorizacion-de-residencia-para-practicas" },
  { country: "Spain", countryCode: "ES", name: "Employee work permit", kind: "Work", note: "Employer-led temporary residence and employment authorization for a qualifying job offer.", authority: "Ministry of Inclusion, Social Security and Migration", url: "https://www.inclusion.gob.es/en/web/migraciones/w/autorizacion-inicial-de-residencia-temporal-y-trabajo-por-cuenta-ajena-hi-16-" },
  { country: "Spain", countryCode: "ES", name: "Highly Qualified Professional / EU Blue Card", kind: "Skilled", note: "Employer-backed residence for qualifying managerial or highly skilled professional employment.", authority: "Large Companies and Strategic Groups Unit", url: "https://inclusion.gob.es/en/web/unidadgrandesempresas/profesionales-altamente-cualificados" },
  { country: "Spain", countryCode: "ES", name: "Youth Mobility / Working Holiday", kind: "Working holiday", note: "Up to one year of youth mobility under Spain's bilateral agreements with eligible partner-country nationals.", authority: "Ministry of Inclusion, Social Security and Migration", url: "https://www.inclusion.gob.es/en/web/migraciones/convenios-de-movilidad-de-jovenes" },

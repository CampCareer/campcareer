...
import { SE_OCCUPATIONS, SE_SHORTAGE_BY_REGION, SE_HIGH_PAY_BY_REGION, SE_UNIVERSITIES, SE_CITIES, type SEOccupation, type SEUniversity, type SECity as SECityData } from "@/data/se-map-data"
import { DK_OCCUPATIONS, DK_SHORTAGE_BY_REGION, DK_HIGH_PAY_BY_REGION, DK_UNIVERSITIES, DK_CITIES, type DKOccupation, type DKUniversity, type DKCity as DKCityData } from "@/data/dk-map-data"
import { FI_OCCUPATIONS, FI_SHORTAGE_BY_REGION, FI_HIGH_PAY_BY_REGION, FI_UNIVERSITIES, FI_CITIES, type FIOccupation, type FIUniversity, type FICity as FICityData } from "@/data/fi-map-data"
...
/**
 * Finland is intentionally a separate bundle until its country release gate
 * permits the map UI and API to request it. Keeping it separate prevents
 * unreviewed data from inflating the shared map shell.
 */
export interface FIMapData {
...
export function getFIMapData(): FIMapData {
  return {
    fiOccupations: FI_OCCUPATIONS,
    fiHighPayByRegion: FI_HIGH_PAY_BY_REGION,
    fiShortageByRegion: FI_SHORTAGE_BY_REGION,
    fiUniversities: FI_UNIVERSITIES,
    fiCities: FI_CITIES,
  }
}

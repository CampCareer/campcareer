...
import { NO_OCCUPATIONS, NO_SHORTAGE_BY_REGION, NO_HIGH_PAY_BY_REGION, NO_UNIVERSITIES, NO_CITIES, type NOOccupation, type NOUniversity, type NOCity as NOCityData } from "@/data/no-map-data"

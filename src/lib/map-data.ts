...
import { NZ_OCCUPATIONS, NZ_SHORTAGE_BY_REGION, NZ_HIGH_PAY_BY_REGION, NZ_UNIVERSITIES, NZ_CITIES, type NZOccupation, type NZUniversity, type NZCity as NZCityData } from "@/data/nz-map-data"

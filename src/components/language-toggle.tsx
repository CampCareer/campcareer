  ...
  return (
    <label className={className ?? 'text-slate-600'}>
      ...
      <select
        ...
        aria-label="Language"
        className="h-8 max-w-[7.75rem] rounded-md bg-transparent px-1.5 text-xs font-medium outline-none transition hover:bg-slate-100 focus-visible:ring-2 focus-visible:ring-blue-500"
      >

...
export function AustraliaReportLaunch() {
  ...
  const copy = isKo ? {
    ...
    freeSteps: [
      ["1", "내 경로 찾기", "목표·예산·기간으로 호주 분야를 좁힙니다."],
    ...
    pathfinder: "호주 경로 찾기", privacy: "개인정보 처리방침", terms: "이용약관", disclaimer: "CampCareer의 데이터와 리포트는 의사결정 보조 자료이며 비자, 입학, 취업, 수입을 보장하지 않습니다.",
  } : {
    ...
    freeSteps: [
      ["1", "Find your path", "Narrow Australia study fields around your goal, budget, and timeline."],
    ...
    pathfinder: "Find my Australia path", privacy: "Privacy Policy", terms: "Terms of Service", disclaimer: "CampCareer data and reports are decision aids. They do not guarantee visa, admission, employment, income, or investment outcomes.",
  }

...
import { SINGAPORE_OCCUPATION_REVIEW_QUEUE } from "@/data/sg-official-data"
...
export const PILOT_OCCUPATIONS: PilotOccupation[] = [...JAPAN_OCCUPATION_REVIEW_QUEUE, ...SINGAPORE_OCCUPATION_REVIEW_QUEUE]

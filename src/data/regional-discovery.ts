...
export const REGIONAL_DISCOVERY: Partial<Record<string, readonly RegionalDiscoveryCard[]>> = {
  ...
  AE: [
    ...
    { code: "RAK", city: "Ras Al Khaimah", region: "Ras Al Khaimah", image: "https://images.unsplash.com/photo-1548013146-72479768bada?w=900&h=620&fit=crop&auto=format", accent: "from-orange-950/65" },
  ],
  US: [

...
const koreaAustraliaStudyOrWorkVisa: RouteGuide["visa"] = {
  ...
  sources: [homeAffairsKoreaUpdate, homeAffairsStudent500, homeAffairsGraduate485, homeAffairsConditions],
}
    ...
    courses: [
      {
        ...
        detail: { en: "A current national training-package qualification to research with an RTO. It is not a universal mining-entry requirement.", ko: "RTO와 검토할 수 있는 현재 국가 훈련패키지 자격입니다. 모든 광업 입직의 공통 요건은 아닙니다." },
        url: trainingGovRii20120.url,
        linkType: "course",
        relevance: { en: "Research it only after the target listing or site states it is relevant.", ko: "지원할 공고나 현장이 관련성을 명시한 뒤에만 검토하세요." },
        source: trainingGovRii20120,
      },
    ],
    employers: [
      {

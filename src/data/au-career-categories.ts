export const AU_CAREER_CATEGORIES = [
  ...
  { id: 5, slug: "business-finance-public-administration", name: "Business, Finance & Public Administration", icon: "chart" },
  ...
  { id: 10, slug: "transport-aviation-maritime-logistics", name: "Transport, Aviation & Maritime", icon: "plane" },
] as const

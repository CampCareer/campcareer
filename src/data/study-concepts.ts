...
export const STUDY_CONCEPTS: StudyConcept[] = [
  ...
  concept({ id: "medicine", slug: "medicine", kind: "STUDY_FIELD", category: "health", label: "Medicine", labelKo: "의학", aliases: ["medical degree", "doctor of medicine", "MD", "clinical medicine"], aliasesKo: ["의대", "의학과", "임상의학"], description: "Medical education leading to provisional or general registration as a medical practitioner.", roiSearchTerm: "Medicine", decisionReady: ["AU"] }),
  concept({ id: "pharmacy", slug: "pharmacy", kind: "STUDY_FIELD", category: "health", label: "Pharmacy", labelKo: "약학", aliases: ["pharmaceutical science", "pharmacist", "clinical pharmacy"], aliasesKo: ["약사", "약대", "약학과"], description: "Pharmacy education and pharmaceutical sciences leading to pharmacist registration.", roiSearchTerm: "Pharmacy", decisionReady: ["AU"] }),
  concept({ id: "finance", slug: "finance", kind: "STUDY_FIELD", category: "business", label: "Finance", labelKo: "금융학", aliases: ["banking", "financial planning", "investment", "corporate finance"], aliasesKo: ["금융", "은행", "재무", "투자"], description: "Financial markets, banking, corporate finance and investment analysis.", roiSearchTerm: "Finance", decisionReady: ["AU"] }),
  concept({ id: "marketing", slug: "marketing", kind: "STUDY_FIELD", category: "business", label: "Marketing", labelKo: "마케팅", aliases: ["digital marketing", "advertising", "brand management", "market research"], aliasesKo: ["디지털마케팅", "광고", "브랜드관리"], description: "Marketing strategy, digital marketing, advertising and consumer behaviour.", roiSearchTerm: "Marketing", decisionReady: ["AU"] }),
  concept({ id: "international-business", slug: "international-business", kind: "STUDY_FIELD", category: "business", label: "International Business", labelKo: "국제경영", aliases: ["global business", "trade", "cross-border management"], aliasesKo: ["국제경영", "무역", "글로벌경영"], description: "International trade, cross-border management and global business strategy.", roiSearchTerm: "International Business", decisionReady: ["AU"] }),
  concept({ id: "commerce", slug: "commerce", kind: "STUDY_FIELD", category: "business", label: "Commerce", labelKo: "상학", aliases: ["Bachelor of Commerce", "BCom", "general commerce"], aliasesKo: ["상학", "상경"], description: "General commerce education covering business, economics and management foundations.", roiSearchTerm: "Commerce", decisionReady: ["AU"] }),
  concept({ id: "tesol", slug: "tesol", kind: "STUDY_FIELD", category: "education", label: "TESOL & English Language Teaching", labelKo: "영어교육", aliases: ["TESOL", "English language teaching", "ELT", "applied linguistics"], aliasesKo: ["영어교수", "영어교육", "TEFL"], description: "Teaching English to speakers of other languages and applied linguistics.", roiSearchTerm: "Education", decisionReady: ["AU"] }),
  concept({ id: "community-welfare", slug: "community-welfare", kind: "STUDY_FIELD", category: "education", label: "Community Welfare & Human Services", labelKo: "사회복지·인간서비스", aliases: ["community services", "human services", "welfare work", "youth services"], aliasesKo: ["사회복지", "인간서비스", "복지행정"], description: "Community welfare, human services, case management and social support work.", roiSearchTerm: "Social Work", decisionReady: ["AU"] }),
  concept({ id: "electrical-engineering", slug: "electrical-engineering", kind: "STUDY_FIELD", category: "engineering", label: "Electrical Engineering", labelKo: "전기공학", aliases: ["electrical and electronic engineering", "power engineering", "control systems"], aliasesKo: ["전기전자공학", "전력공학", "제어공학"], description: "Electrical systems, electronics, power generation and control engineering.", roiSearchTerm: "Electrical Engineering", decisionReady: ["AU"] }),
  concept({ id: "interior-design", slug: "interior-design", kind: "STUDY_FIELD", category: "design", label: "Interior Design", labelKo: "인테리어디자인", aliases: ["interior architecture", "spatial design", "fitout design"], aliasesKo: ["인테리어", "공간설계", "실내건축"], description: "Interior design, spatial planning and built environment aesthetics.", roiSearchTerm: "Architecture", decisionReady: ["AU"] }),
]

...
const preservedCompareCountries = ["AU", "BE", "CA", "DE", "DK", "FI", "FR", "NL", "NZ", "SE", "UK", "US"]
...
test("Spain Phase 9 preserves all pre-existing shared City Compare countries", () => {
...
test("Spain Phase 9 preserves pre-existing published city route constants", () => {
...
test("Spain Phase 9 keeps release actions outside the application contract", () => {
